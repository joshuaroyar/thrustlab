this is related to the overhaul station tab of the webiste

task 1 :
    1.1 
        i want you to remove everything present in the overhaul station tab, i will futher provide information on what is to be filled
    1.2
        now i want you to add the morning theme of sky with the clouds and sun only in the background of the overhaul station tab
    1.3    
        now i want you to add a heading at the top center of the overhaul station tab that says "Overhaul Station"and below it i want these content which is 'Step into the Overhaul Bay, where hands-on learning takes flight. In this interactive zone, students dive into the intricate process of assembling and disassembling turbofan engine components—gaining a deeper understanding of each part’s role and the essential principles of gas turbine engine overhaul. It’s where theory meets practice, transforming knowledge into real-world technical skill.'
    1.4 
        now i want you to add two containers side by side in the overhaul station tab and its content will be provided 
    1.5 
        container 1 content : 
        heading : "Preliminary Laboratory Module"
        paragraph : This module familiarizes students with the key steps of gas turbine engine overhaul—disassembly, inspection, repair, and testing—emphasizing efficiency, reliability, and hands-on maintenance skills.
    1.6 
        container 2 content : 
        heading : "Assembly and Disassembly Activity"
        paragraph : Students gain hands-on experience in taking apart and reassembling the main components of a turbofan engine, developing practical skills, precision, and a deeper understanding of how each part works together.
    1.7 
        when second container is cicked i want a pop up with a message that says "coming soon" and further instruction for what should happen in this popup, this instruction will be provided in asmb-disamb.md file in overhaul-tab folder

task 2 : 
    2.1 
        when the first container is clicked i want a popup to   appear which will be like a reading mode of an a4 sheet and when escape button is presseed the popup will disappear
    2.2 
        in 2.3 i will be pasting the content for the popup and i will also be pasing the link for the images to be used in the popup  and the youtube video link will be provided to play in the popup
    2.3
        popup content for container 1 :

        PRELIMINARY LABORATORY MODULE 
...
reliable that they are overhauled only when they need major maintenance. This concept is a form of "on condition" maintenance or overhaul.
...
https://www.youtube.com/watch?v=hQri0heCepA
...
/home/joyboy/Desktop/ThrustLab/thrustlab/docs/main md files/overhaul-tab/preliminary-tab/img 1.png

Typical overhaul workshop layout
...
/home/joyboy/Desktop/ThrustLab/thrustlab/docs/main md files/overhaul-tab/preliminary-tab/img 3.png
